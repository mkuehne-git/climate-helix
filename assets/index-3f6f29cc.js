...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:en,depthTest:!1,depthWrite:!1})}function Uc(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nl(),fragmentShader:`
		...
		`,blending:en,depthTest:!1,depthWrite:!1})}function yc(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nl(),fragmentShader:`
...
</svg>`,t2={id:"close",svg:e2};var Yt,En,Jt;class n2{constructor(A){re(this,Yt,void 0);re(this,En,void 0);re(this,Jt,void 0);$A(this,Yt,!0),$A(this,En,new fl({container:document.querySelector(".container-div"),icons:[A2,t2],classToken:"settings",event:XA.SETTINGS_CHANGED})),$A(this,Jt,A),gA(this,Jt).hide(),gA(this,En).show(gA(this,Yt)?0:1),gA(this,En).addOnClickListener(()=>this.guiShowHide())}guiShowHide(){gA(this,Yt)?(this.toggle(),gA(this,Jt).show(),gA(this,Jt).open()):gA(this,Jt).$title.click()}toggle(){$A(this,Yt,!gA(this,Yt)),gA(this,En).toggle()}}Yt=new WeakMap,En=new WeakMap,Jt=new WeakMap;const i2=`Land-Ocean: Global Means
...
2023,.44,.62,.80,***,***,***,***,***,***,***,***,***,***,***,.53,***,***,***
`,si={},Ae={showcaseCSV:void 0,radio:ir.GLOBAL,view:{geometry:{meshVisible:!1,facesVisible:!0,radialSegments:8,radius:1,radiusFactor:.9,tubularSegments:30},colors:{cold:uo("cold"),zero:uo("zero"),warm:uo("warm")}},capture:{},imprint:()=>XA.dispatchEvent(XA.SHOW_IMPRINT)};function uo(n){return{color:Ji(n),modified:!1}}function Ji(n){return Mf(`--${n}-color`)}function Mf(n){const e=window.getComputedStyle(document.body).getPropertyValue(n);return new YA(e)}var gr,xn,Bi,Pe;const Ks=class Ks{constructor(){re(this,gr,void 0);re(this,xn,void 0);re(this,Bi,void 0);re(this,Pe,void 0);$A(this,Pe,new il({container:document.querySelector(".container-div"),autoPlace:!1})),gA(this,Pe).domElement.id="gui",this.createShowcaseFolder(),this.createViewFolder(),this.createCaptureFolder(),this.createImprint(),this.createShowHideListener(),this.createSettingsIcon()}static styledColor(A){return Mf(A)}static addRadioButtonsFolder(A,e,t,i,r=(s,a,o)=>{}){const s=A.addFolder(e);return Ks.addRadioButtons(s,t,i,r),s}static addRadioButtons(A,e,t,i=(r,s,a)=>{}){const r={};Object.entries(t).forEach(s=>{const[a,o]=s,l=`option_${a}`;r[l]=e===a}),Object.keys(t).forEach(s=>{const a=`option_${s}`;A.add(r,a).name(s).listen().onChange(()=>{for(let o in r)r[o]=a===o;i(r,a,s)})})}createSettingsIcon(){const A=new n2(gA(this,Pe));new hl(gA(this,Pe).domElement,(e,t)=>{const i=e.target;t===0&&!(i!=null&&i.classList.contains("transition"))&&(i!=null&&i.classList.contains("closed"))&&(gA(this,Pe).hide(),gA(this,Pe).close(),A.toggle())})}createShowHideListener(){window.addEventListener("keydown",A=>{(A.key==="h"||A.key==="H")&&(gA(this,Bi)?gA(this,Pe).show():gA(this,Pe).hide(),$A(this,Bi,!gA(this,Bi)))})}createShowcaseFolder(){si[ir.GLOBAL]=i2,si[ir.NORTHERN_HEMISSPHERE]=r2,si[ir.SOUTHERN_HEMISSPHERE]=s2,$A(this,xn,Ks.addRadioButtonsFolder(gA(this,Pe),`Region: ${Ae.radio}`,Ae.radio,si,(A,e,t)=>{Ae.showcaseCSV=si[t],XA.dispatchEvent(XA.CREATE_HELIX),gA(this,xn).title(`Region: ${t}`),gA(this,xn).close()})),Ae.showcaseCSV=si[Ae.radio],gA(this,xn).close()}createViewFolder(){const A=gA(this,Pe).addFolder("View");this.createViewGeometryFolder(A),this.createViewColorsFolder(A),A.close()}createViewGeometryFolder(A){const e=A.addFolder("Geometry"),t=Ae.view.geometry;e.add(t,"meshVisible").name("Wireframe").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"facesVisible").name("Faces").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"tubularSegments").min(1).max(31).step(1).name("Monthly Segments").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"radialSegments").min(3).max(32).step(1).name("Radius Segments").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"radiusFactor").min(.1).max(2).name("Radius Factor").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.close()}createViewColorsFolder(A){const e=A.addFolder("Colors"),t=Ae.view.colors;e.addColor(t.cold,"color").name("-1.0°C").listen().onChange(()=>this.dispatchColorEvent("cold")),e.addColor(t.zero,"color").name("0°C").listen().onChange(()=>this.dispatchColorEvent("zero")),e.addColor(t.warm,"color").name("+1.5°C").listen().onChange(()=>this.dispatchColorEvent("warm")),e.close()}initializeColors(){Ae.view.colors.cold.modified||(Ae.view.colors.cold.color=Ji("cold")),Ae.view.colors.zero.modified||(Ae.view.colors.zero.color=Ji("zero")),Ae.view.colors.warm.modified||(Ae.view.colors.warm.color=Ji("warm"))}dispatchColorEvent(A){Ae.view.colors[A].modified=!Ae.view.colors[A].color.equals(Ji(A)),XA.dispatchEvent(XA.CREATE_HELIX)}createCaptureFolder(){const A=gA(this,Pe).addFolder("Screen capture");A.close(),$A(this,gr,A)}createImprint(){new ZE().isAvailable().then(t=>{t&&gA(this,Pe).add(Ae,"imprint").name("Imprint")})}get showcaseCSV(){return Ae.showcaseCSV}get radialSegments(){return Math.floor(Ae.view.geometry.radialSegments)}get radiusFactor(){return Ae.view.geometry.radiusFactor}get tubularSegments(){return Math.floor(Ae.view.geometry.tubularSegments)}get showFaces(){return Ae.view.geometry.facesVisible}get showWireframe(){return Ae.view.geometry.meshVisible}get cold(){return Ae.view.colors.cold.color}get zero(){return Ae.view.colors.zero.color}get warm(){return Ae.view.colors.warm.color}captureSettings(){return{folder:gA(this,gr),property:Ae.capture}}};gr=new WeakMap,xn=new WeakMap,Bi=new WeakMap,Pe=new WeakMap;let dr=Ks;const a2=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="512" height="512">
...
</svg>`,c2={id:"dark",svg:l2},ho="dark",fo="light";var mt,wi;class u2{constructor(A){re(this,mt,void 0);re(this,wi,void 0);$A(this,wi,new fl({container:(A==null?void 0:A.container)||document.body,icons:[o2,c2],classToken:"themes",event:XA.CHANGE_THEME.toString()})),this.initTheme(),this.registerOnThemeChange(document.body)}initTheme(){$A(this,mt,this.preferredTheme()),document.body.classList.add(gA(this,mt)?ho:fo),gA(this,wi).show(gA(this,mt)?0:1),XA.dispatchEvent(XA.THEME_CHANGED)}preferredTheme(){return window.matchMedia("(prefers-color-scheme: dark)").matches}registerOnThemeChange(A){A.addEventListener(XA.CHANGE_THEME.toString(),()=>{this.onThemeChange(A)})}onThemeChange(A){const e=gA(this,mt)?ho:fo,t=gA(this,mt)?fo:ho;A.classList.replace(e,t)||A.classList.add(t),$A(this,mt,!gA(this,mt)),gA(this,wi).toggle(),XA.dispatchEvent(XA.THEME_CHANGED)}}mt=new WeakMap,wi=new WeakMap;const h2=`<?xml version="1.0" ?>
...
</ol>`,sa=document.createElement("DIV"),Lf=".container-div";sa.setAttribute("class","container-div");document.body.appendChild(sa);const rr=new dr,x2=new u2({container:sa});let hi,Cn,sr,Xt,ws,vs;function U2(){sr=new l1,Xt=new Eh({antialias:!0}),Xt.setPixelRatio(window.devicePixelRatio);const n=window.innerWidth,A=window.innerHeight;Xt.setSize(n,A),sa.appendChild(Xt.domElement),y2();const e=n/A;Cn=new At(50,e),Cn.position.set(0,0,5.5),sr.add(Cn),hi=new Gi,sr.add(hi),new B2(Cn,Xt.domElement).update(),window.addEventListener("resize",b2),window.addEventListener(XA.CREATE_HELIX,Rf),document.body.addEventListener(XA.THEME_CHANGED.toString(),M2);const i={All:document.body,Helix:Xt.domElement};new C2(rr.captureSettings(),i),S2(),F2(),XA.dispatchEvent(XA.THEME_CHANGED),Hf()}function y2(){return new hl(document.body,n=>{const e=window.getComputedStyle(document.body).getPropertyValue("background-color");sr.background=new YA(e)})}function Rf(){ws&&hi.remove(ws),vs&&hi.remove(vs);const n=new v2(rr);rr.showFaces&&(ws=n.createMesh(),hi.add(ws)),rr.showWireframe&&(vs=n.createMesh({wireframe:!0,vertexColors:!1}),hi.add(vs));const A=document.querySelector(Lf);n.createTitleDiv(A)}function S2(){const n=document.querySelector(Lf)||document.body;new g2(n)}function F2(){const n=document.createElement("DIV");n.setAttribute("id","info-div"),n.innerHTML=E2;const A=document.querySelector(".info-button");A==null||A.insertAdjacentElement("beforebegin",n);const e=document.createElement("SPAN");e.setAttribute("id","version-info"),e.innerHTML="v0.2.7",A==null||A.insertAdjacentElement("beforebegin",e)}function Hf(){requestAnimationFrame(Hf),Xt.render(sr,Cn)}function M2(){rr.initializeColors(),Rf()}function b2(){Cn.aspect=window.innerWidth/window.innerHeight,Cn.updateProjectionMatrix(),Xt.setSize(window.innerWidth,window.innerHeight)}U2();x2.initTheme();
