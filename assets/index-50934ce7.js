...
</svg>`,t2={id:"close",svg:e2};var Yt,En,Jt;class n2{constructor(A){re(this,Yt,void 0);re(this,En,void 0);re(this,Jt,void 0);$A(this,Yt,!0),$A(this,En,new fl({container:document.querySelector(".container-div"),icons:[A2,t2],classToken:"settings",event:XA.SETTINGS_CHANGED})),$A(this,Jt,A),BA(this,Jt).hide(),BA(this,En).show(BA(this,Yt)?0:1),BA(this,En).addOnClickListener(()=>this.guiShowHide())}guiShowHide(){BA(this,Yt)?(this.toggle(),BA(this,Jt).show(),BA(this,Jt).open()):BA(this,Jt).$title.click()}toggle(){$A(this,Yt,!BA(this,Yt)),BA(this,En).toggle()}}Yt=new WeakMap,En=new WeakMap,Jt=new WeakMap;const i2=`Land-Ocean: Global Means
...
2023,.44,.62,.80,***,***,***,***,***,***,***,***,***,***,***,.53,***,***,***
`,ri={},Ae={showcaseCSV:void 0,radio:nr.GLOBAL,view:{geometry:{meshVisible:!1,facesVisible:!0,radialSegments:8,radius:1,radiusFactor:.9,tubularSegments:30},colors:{cold:uo("cold"),zero:uo("zero"),warm:uo("warm")}},capture:{},imprint:()=>XA.dispatchEvent(XA.SHOW_IMPRINT)};function uo(n){return{color:Yi(n),modified:!1}}function Yi(n){return Mf(`--${n}-color`)}function Mf(n){const e=window.getComputedStyle(document.body).getPropertyValue(n);return new YA(e)}var pr,xn,mi,Pe;const Ks=class Ks{constructor(){re(this,pr,void 0);re(this,xn,void 0);re(this,mi,void 0);re(this,Pe,void 0);$A(this,Pe,new il({container:document.querySelector(".container-div"),autoPlace:!1})),BA(this,Pe).domElement.id="gui",this.createShowcaseFolder(),this.createViewFolder(),this.createCaptureFolder(),this.createImprint(),this.createShowHideListener(),this.createSettingsIcon()}static styledColor(A){return Mf(A)}static addRadioButtonsFolder(A,e,t,i,r=(s,a,o)=>{}){const s=A.addFolder(e);return Ks.addRadioButtons(s,t,i,r),s}static addRadioButtons(A,e,t,i=(r,s,a)=>{}){const r={};Object.entries(t).forEach(s=>{const[a,o]=s,l=`option_${a}`;r[l]=e===a}),Object.keys(t).forEach(s=>{const a=`option_${s}`;A.add(r,a).name(s).listen().onChange(()=>{for(let o in r)r[o]=a===o;i(r,a,s)})})}createSettingsIcon(){const A=new n2(BA(this,Pe));new hl(BA(this,Pe).domElement,(e,t)=>{const i=e.target;t===0&&!(i!=null&&i.classList.contains("transition"))&&(i!=null&&i.classList.contains("closed"))&&(BA(this,Pe).hide(),BA(this,Pe).close(),A.toggle())})}createShowHideListener(){window.addEventListener("keydown",A=>{(A.key==="h"||A.key==="H")&&(BA(this,mi)?BA(this,Pe).show():BA(this,Pe).hide(),$A(this,mi,!BA(this,mi)))})}createShowcaseFolder(){ri[nr.GLOBAL]=i2,ri[nr.NORTHERN_HEMISSPHERE]=r2,ri[nr.SOUTHERN_HEMISSPHERE]=s2,$A(this,xn,Ks.addRadioButtonsFolder(BA(this,Pe),`Region: ${Ae.radio}`,Ae.radio,ri,(A,e,t)=>{Ae.showcaseCSV=ri[t],XA.dispatchEvent(XA.CREATE_HELIX),BA(this,xn).title(`Region: ${t}`),BA(this,xn).close()})),Ae.showcaseCSV=ri[Ae.radio],BA(this,xn).close()}createViewFolder(){const A=BA(this,Pe).addFolder("View");this.createViewGeometryFolder(A),this.createViewColorsFolder(A),A.close()}createViewGeometryFolder(A){const e=A.addFolder("Geometry"),t=Ae.view.geometry;e.add(t,"meshVisible").name("Wireframe").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"facesVisible").name("Faces").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"tubularSegments").min(1).max(31).step(1).name("Monthly Segments").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"radialSegments").min(3).max(32).step(1).name("Radius Segments").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"radiusFactor").min(.1).max(2).name("Radius Factor").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.close()}createViewColorsFolder(A){const e=A.addFolder("Colors"),t=Ae.view.colors;e.addColor(t.cold,"color").name("-1.0°C").listen().onChange(()=>this.dispatchColorEvent("cold")),e.addColor(t.zero,"color").name("0°C").listen().onChange(()=>this.dispatchColorEvent("zero")),e.addColor(t.warm,"color").name("+1.5°C").listen().onChange(()=>this.dispatchColorEvent("warm")),e.close()}initializeColors(){Ae.view.colors.cold.modified||(Ae.view.colors.cold.color=Yi("cold")),Ae.view.colors.zero.modified||(Ae.view.colors.zero.color=Yi("zero")),Ae.view.colors.warm.modified||(Ae.view.colors.warm.color=Yi("warm"))}dispatchColorEvent(A){Ae.view.colors[A].modified=!Ae.view.colors[A].color.equals(Yi(A)),XA.dispatchEvent(XA.CREATE_HELIX)}createCaptureFolder(){const A=BA(this,Pe).addFolder("Screen capture");A.close(),$A(this,pr,A)}createImprint(){new ZE().isAvailable().then(t=>{t&&BA(this,Pe).add(Ae,"imprint").name("Imprint")})}get showcaseCSV(){return Ae.showcaseCSV}get radialSegments(){return Math.floor(Ae.view.geometry.radialSegments)}get radiusFactor(){return Ae.view.geometry.radiusFactor}get tubularSegments(){return Math.floor(Ae.view.geometry.tubularSegments)}get showFaces(){return Ae.view.geometry.facesVisible}get showWireframe(){return Ae.view.geometry.meshVisible}get cold(){return Ae.view.colors.cold.color}get zero(){return Ae.view.colors.zero.color}get warm(){return Ae.view.colors.warm.color}captureSettings(){return{folder:BA(this,pr),property:Ae.capture}}};pr=new WeakMap,xn=new WeakMap,mi=new WeakMap,Pe=new WeakMap;let fr=Ks;const a2=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="512" height="512">
...
</svg>`,c2={id:"dark",svg:l2},ho="dark",fo="light";var mt,Bi;class u2{constructor(A){re(this,mt,void 0);re(this,Bi,void 0);$A(this,Bi,new fl({container:(A==null?void 0:A.container)||document.body,icons:[o2,c2],classToken:"themes",event:XA.CHANGE_THEME.toString()})),this.initTheme(),this.registerOnThemeChange(document.body)}initTheme(){$A(this,mt,this.preferredTheme()),document.body.classList.add(BA(this,mt)?ho:fo),BA(this,Bi).show(BA(this,mt)?0:1),XA.dispatchEvent(XA.THEME_CHANGED)}preferredTheme(){return window.matchMedia("(prefers-color-scheme: dark)").matches}registerOnThemeChange(A){A.addEventListener(XA.CHANGE_THEME.toString(),()=>{this.onThemeChange(A)})}onThemeChange(A){const e=BA(this,mt)?ho:fo,t=BA(this,mt)?fo:ho;A.classList.replace(e,t)||A.classList.add(t),$A(this,mt,!BA(this,mt)),BA(this,Bi).toggle(),XA.dispatchEvent(XA.THEME_CHANGED)}}mt=new WeakMap,Bi=new WeakMap;const h2=`<?xml version="1.0" ?>
...
</ol>`,sa=document.createElement("DIV"),Lf=".container-div";sa.setAttribute("class","container-div");document.body.appendChild(sa);const ir=new fr,x2=new u2({container:sa});let ui,Cn,rr,Xt,ws,vs;function U2(){rr=new l1,Xt=new Eh({antialias:!0}),Xt.setPixelRatio(window.devicePixelRatio);const n=window.innerWidth,A=window.innerHeight;Xt.setSize(n,A),sa.appendChild(Xt.domElement),y2();const e=n/A;Cn=new At(50,e),Cn.position.set(0,0,5.5),rr.add(Cn),ui=new Oi,rr.add(ui),new B2(Cn,Xt.domElement).update(),window.addEventListener("resize",b2),window.addEventListener(XA.CREATE_HELIX,Rf),document.body.addEventListener(XA.THEME_CHANGED.toString(),M2);const i={All:document.body,Helix:Xt.domElement};new C2(ir.captureSettings(),i),S2(),F2(),XA.dispatchEvent(XA.THEME_CHANGED),Hf()}function y2(){return new hl(document.body,n=>{const e=window.getComputedStyle(document.body).getPropertyValue("background-color");rr.background=new YA(e)})}function Rf(){ws&&ui.remove(ws),vs&&ui.remove(vs);const n=new v2(ir);ir.showFaces&&(ws=n.createMesh(),ui.add(ws)),ir.showWireframe&&(vs=n.createMesh({wireframe:!0,vertexColors:!1}),ui.add(vs));const A=document.querySelector(Lf);n.createTitleDiv(A)}function S2(){const n=document.querySelector(Lf);new g2(n)}function F2(){const n=document.createElement("DIV");n.setAttribute("id","info-div"),n.innerHTML=E2;const A=document.querySelector(".info-button");A==null||A.insertAdjacentElement("beforebegin",n);const e=document.createElement("SPAN");e.setAttribute("id","version-info"),e.innerHTML="v0.2.5",A==null||A.insertAdjacentElement("beforebegin",e)}function Hf(){requestAnimationFrame(Hf),Xt.render(rr,Cn)}function M2(){ir.initializeColors(),Rf()}function b2(){Cn.aspect=window.innerWidth/window.innerHeight,Cn.updateProjectionMatrix(),Xt.setSize(window.innerWidth,window.innerHeight)}U2();x2.initTheme();
