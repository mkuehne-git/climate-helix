...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yt,depthTest:!1,depthWrite:!1})}function Gl(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Mo(),fragmentShader:`
		...
		`,blending:Yt,depthTest:!1,depthWrite:!1})}function Vl(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Mo(),fragmentShader:`
...
#define LOW_PRECISION`),A}function wm(n){let A="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===lu?A="SHADOWMAP_TYPE_PCF":n.shadowMapType===$h?A="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===yt&&(A="SHADOWMAP_TYPE_VSM"),A}function vm(n){let A="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case gi:case mi:A="ENVMAP_TYPE_CUBE";break;case xs:A="ENVMAP_TYPE_CUBE_UV";break}return A}function _m(n){let A="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case mi:A="ENVMAP_MODE_REFRACTION";break}return A}function Cm(n){let A="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case hu:A="ENVMAP_BLENDING_MULTIPLY";break;case vf:A="ENVMAP_BLENDING_MIX";break;case _f:A="ENVMAP_BLENDING_ADD";break}return A}function Em(n){const A=n.envMapCubeUVHeight;if(A===null)return null;const e=Math.log2(A)-2,t=1/A;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:t,maxMip:e}}function xm(n,A,e,t){const i=n.getContext(),r=e.defines;let s=e.vertexShader,a=e.fragmentShader;const o=wm(e),l=vm(e),c=_m(e),u=Cm(e),h=Em(e),d=e.isWebGL2?"":hm(e),g=fm(r),m=i.createProgram();let p,f,_=e.glslVersion?"#version "+e.glslVersion+`
