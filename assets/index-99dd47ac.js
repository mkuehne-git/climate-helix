...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:en,depthTest:!1,depthWrite:!1})}function xc(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nl(),fragmentShader:`
		...
		`,blending:en,depthTest:!1,depthWrite:!1})}function Uc(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nl(),fragmentShader:`
...
#define LOW_PRECISION`),A}function MB(n){let A="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Yu?A="SHADOWMAP_TYPE_PCF":n.shadowMapType===kf?A="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===bt&&(A="SHADOWMAP_TYPE_VSM"),A}function bB(n){let A="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ci:case Ei:A="ENVMAP_TYPE_CUBE";break;case zs:A="ENVMAP_TYPE_CUBE_UV";break}return A}function TB(n){let A="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Ei:A="ENVMAP_MODE_REFRACTION";break}return A}function QB(n){let A="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Ju:A="ENVMAP_BLENDING_MULTIPLY";break;case dd:A="ENVMAP_BLENDING_MIX";break;case pd:A="ENVMAP_BLENDING_ADD";break}return A}function LB(n){const A=n.envMapCubeUVHeight;if(A===null)return null;const e=Math.log2(A)-2,t=1/A;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:t,maxMip:e}}function IB(n,A,e,t){const i=n.getContext(),r=e.defines;let s=e.vertexShader,a=e.fragmentShader;const o=MB(e),l=bB(e),c=TB(e),u=QB(e),h=LB(e),p=e.isWebGL2?"":_B(e),g=CB(r),m=i.createProgram();let d,f,E=e.glslVersion?"#version "+e.glslVersion+`
...
</svg>`,t2={id:"close",svg:e2};var Yt,En,Jt;class n2{constructor(A){se(this,Yt,void 0);se(this,En,void 0);se(this,Jt,void 0);jA(this,Yt,!0),jA(this,En,new Ff({container:document.querySelector(".container-div"),icons:[A2,t2],classToken:"settings",event:XA.SETTINGS_CHANGED})),jA(this,Jt,A),wA(this,Jt).hide(),wA(this,En).show(wA(this,Yt)?0:1),wA(this,En).addOnClickListener(()=>this.guiShowHide())}guiShowHide(){wA(this,Yt)?(this.toggle(),wA(this,Jt).show(),wA(this,Jt).open()):wA(this,Jt).$title.click()}toggle(){jA(this,Yt,!wA(this,Yt)),wA(this,En).toggle()}}Yt=new WeakMap,En=new WeakMap,Jt=new WeakMap;const i2=`Land-Ocean: Global Means
...
2023,.44,.62,.80,***,***,***,***,***,***,***,***,***,***,***,.53,***,***,***
`,ri={},Ae={showcaseCSV:void 0,radio:ir.GLOBAL,view:{geometry:{meshVisible:!1,facesVisible:!0,radialSegments:8,radius:1,radiusFactor:.9,tubularSegments:30},colors:{cold:uo("cold"),zero:uo("zero"),warm:uo("warm")}},capture:{},imprint:()=>XA.dispatchEvent(XA.SHOW_IMPRINT)};function uo(n){return{color:Yi(n),modified:!1}}function Yi(n){return Mf(`--${n}-color`)}function Mf(n){const e=window.getComputedStyle(document.body).getPropertyValue(n);return new YA(e)}var gr,xn,mi,Pe;const Ks=class Ks{constructor(){se(this,gr,void 0);se(this,xn,void 0);se(this,mi,void 0);se(this,Pe,void 0);jA(this,Pe,new il({container:document.querySelector(".container-div"),autoPlace:!1})),wA(this,Pe).domElement.id="gui",this.createShowcaseFolder(),this.createViewFolder(),this.createCaptureFolder(),this.createImprint(),this.createShowHideListener(),this.createSettingsIcon()}static styledColor(A){return Mf(A)}static addRadioButtonsFolder(A,e,t,i,r=(s,a,o)=>{}){const s=A.addFolder(e);return Ks.addRadioButtons(s,t,i,r),s}static addRadioButtons(A,e,t,i=(r,s,a)=>{}){const r={};Object.entries(t).forEach(s=>{const[a,o]=s,l=`option_${a}`;r[l]=e===a}),Object.keys(t).forEach(s=>{const a=`option_${s}`;A.add(r,a).name(s).listen().onChange(()=>{for(let o in r)r[o]=a===o;i(r,a,s)})})}createSettingsIcon(){const A=new n2(wA(this,Pe));new hl(wA(this,Pe).domElement,(e,t)=>{const i=e.target;t===0&&!(i!=null&&i.classList.contains("transition"))&&(i!=null&&i.classList.contains("closed"))&&(wA(this,Pe).hide(),wA(this,Pe).close(),A.toggle())})}createShowHideListener(){window.addEventListener("keydown",A=>{(A.key==="h"||A.key==="H")&&(wA(this,mi)?wA(this,Pe).show():wA(this,Pe).hide(),jA(this,mi,!wA(this,mi)))})}createShowcaseFolder(){ri[ir.GLOBAL]=i2,ri[ir.NORTHERN_HEMISSPHERE]=r2,ri[ir.SOUTHERN_HEMISSPHERE]=s2,jA(this,xn,Ks.addRadioButtonsFolder(wA(this,Pe),`Region: ${Ae.radio}`,Ae.radio,ri,(A,e,t)=>{Ae.showcaseCSV=ri[t],XA.dispatchEvent(XA.CREATE_HELIX),wA(this,xn).title(`Region: ${t}`),wA(this,xn).close()})),Ae.showcaseCSV=ri[Ae.radio],wA(this,xn).close()}createViewFolder(){const A=wA(this,Pe).addFolder("View");this.createViewGeometryFolder(A),this.createViewColorsFolder(A),A.close()}createViewGeometryFolder(A){const e=A.addFolder("Geometry"),t=Ae.view.geometry;e.add(t,"meshVisible").name("Wireframe").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"facesVisible").name("Faces").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"tubularSegments").min(1).max(31).step(1).name("Monthly Segments").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"radialSegments").min(3).max(32).step(1).name("Radius Segments").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.add(t,"radiusFactor").min(.1).max(2).name("Radius Factor").onChange(()=>XA.dispatchEvent(XA.CREATE_HELIX)),e.close()}createViewColorsFolder(A){const e=A.addFolder("Colors"),t=Ae.view.colors;e.addColor(t.cold,"color").name("-1.0°C").listen().onChange(()=>this.dispatchColorEvent("cold")),e.addColor(t.zero,"color").name("0°C").listen().onChange(()=>this.dispatchColorEvent("zero")),e.addColor(t.warm,"color").name("+1.5°C").listen().onChange(()=>this.dispatchColorEvent("warm")),e.close()}initializeColors(){Ae.view.colors.cold.modified||(Ae.view.colors.cold.color=Yi("cold")),Ae.view.colors.zero.modified||(Ae.view.colors.zero.color=Yi("zero")),Ae.view.colors.warm.modified||(Ae.view.colors.warm.color=Yi("warm"))}dispatchColorEvent(A){Ae.view.colors[A].modified=!Ae.view.colors[A].color.equals(Yi(A)),XA.dispatchEvent(XA.CREATE_HELIX)}createCaptureFolder(){const A=wA(this,Pe).addFolder("Screen capture");A.close(),jA(this,gr,A)}createImprint(){new ZE().isAvailable().then(t=>{t&&wA(this,Pe).add(Ae,"imprint").name("Imprint")})}get showcaseCSV(){return Ae.showcaseCSV}get radialSegments(){return Math.floor(Ae.view.geometry.radialSegments)}get radiusFactor(){return Ae.view.geometry.radiusFactor}get tubularSegments(){return Math.floor(Ae.view.geometry.tubularSegments)}get showFaces(){return Ae.view.geometry.facesVisible}get showWireframe(){return Ae.view.geometry.meshVisible}get cold(){return Ae.view.colors.cold.color}get zero(){return Ae.view.colors.zero.color}get warm(){return Ae.view.colors.warm.color}captureSettings(){return{folder:wA(this,gr),property:Ae.capture}}};gr=new WeakMap,xn=new WeakMap,mi=new WeakMap,Pe=new WeakMap;let dr=Ks;const a2=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="512" height="512">
...
</svg>`,c2={id:"dark",svg:l2},ho="dark",fo="light";var mt,Bi;class u2{constructor(A){se(this,mt,void 0);se(this,Bi,void 0);jA(this,Bi,new Ff({container:(A==null?void 0:A.container)||document.body,icons:[o2,c2],classToken:"themes",event:XA.CHANGE_THEME.toString()})),this.initTheme(),this.registerOnThemeChange(document.body)}initTheme(){jA(this,mt,this.preferredTheme()),document.body.classList.add(wA(this,mt)?ho:fo),wA(this,Bi).show(wA(this,mt)?0:1),XA.dispatchEvent(XA.THEME_CHANGED)}preferredTheme(){return window.matchMedia("(prefers-color-scheme: dark)").matches}registerOnThemeChange(A){A.addEventListener(XA.CHANGE_THEME.toString(),()=>{this.onThemeChange(A)})}onThemeChange(A){const e=wA(this,mt)?ho:fo,t=wA(this,mt)?fo:ho;A.classList.replace(e,t)||A.classList.add(t),jA(this,mt,!wA(this,mt)),wA(this,Bi).toggle(),XA.dispatchEvent(XA.THEME_CHANGED)}}mt=new WeakMap,Bi=new WeakMap;const zu={type:"change"},po={type:"start"},Wu={type:"end"},Bs=new oh,Xu=new zt,h2=Math.cos(70*np.DEG2RAD);class f2 extends In{constructor(A,e){super(),this.object=A,this.domElement=e,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new L,this.cursor=new L,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Rn.ROTATE,MIDDLE:Rn.DOLLY,RIGHT:Rn.PAN},this.touches={ONE:Hn.ROTATE,TWO:Hn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(M){M.addEventListener("keydown",w),this._domElementKeyEvents=M},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",w),this._domElementKeyEvents=null},this.saveState=function(){t.target0.copy(t.target),t.position0.copy(t.object.position),t.zoom0=t.object.zoom},this.reset=function(){t.target.copy(t.target0),t.object.position.copy(t.position0),t.object.zoom=t.zoom0,t.object.updateProjectionMatrix(),t.dispatchEvent(zu),t.update(),r=i.NONE},this.update=function(){const M=new L,iA=new Qn().setFromUnitVectors(A.up,new L(0,1,0)),q=iA.clone().invert(),UA=new L,BA=new Qn,xA=new L,gA=2*Math.PI;return function(VA=null){const b=t.object.position;M.copy(b).sub(t.target),M.applyQuaternion(iA),a.setFromVector3(M),t.autoRotate&&r===i.NONE&&k(B(VA)),t.enableDamping?(a.theta+=o.theta*t.dampingFactor,a.phi+=o.phi*t.dampingFactor):(a.theta+=o.theta,a.phi+=o.phi);let aA=t.minAzimuthAngle,AA=t.maxAzimuthAngle;isFinite(aA)&&isFinite(AA)&&(aA<-Math.PI?aA+=gA:aA>Math.PI&&(aA-=gA),AA<-Math.PI?AA+=gA:AA>Math.PI&&(AA-=gA),aA<=AA?a.theta=Math.max(aA,Math.min(AA,a.theta)):a.theta=a.theta>(aA+AA)/2?Math.max(aA,a.theta):Math.min(AA,a.theta)),a.phi=Math.max(t.minPolarAngle,Math.min(t.maxPolarAngle,a.phi)),a.makeSafe(),t.enableDamping===!0?t.target.addScaledVector(c,t.dampingFactor):t.target.add(c),t.target.sub(t.cursor),t.target.clampLength(t.minTargetRadius,t.maxTargetRadius),t.target.add(t.cursor),t.zoomToCursor&&y||t.object.isOrthographicCamera?a.radius=Z(a.radius):a.radius=Z(a.radius*l),M.setFromSpherical(a),M.applyQuaternion(q),b.copy(t.target).add(M),t.object.lookAt(t.target),t.enableDamping===!0?(o.theta*=1-t.dampingFactor,o.phi*=1-t.dampingFactor,c.multiplyScalar(1-t.dampingFactor)):(o.set(0,0,0),c.set(0,0,0));let z=!1;if(t.zoomToCursor&&y){let nA=null;if(t.object.isPerspectiveCamera){const CA=M.length();nA=Z(CA*l);const KA=CA-nA;t.object.position.addScaledVector(C,KA),t.object.updateMatrixWorld()}else if(t.object.isOrthographicCamera){const CA=new L(x.x,x.y,0);CA.unproject(t.object),t.object.zoom=Math.max(t.minZoom,Math.min(t.maxZoom,t.object.zoom/l)),t.object.updateProjectionMatrix(),z=!0;const KA=new L(x.x,x.y,0);KA.unproject(t.object),t.object.position.sub(KA).add(CA),t.object.updateMatrixWorld(),nA=M.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),t.zoomToCursor=!1;nA!==null&&(this.screenSpacePanning?t.target.set(0,0,-1).transformDirection(t.object.matrix).multiplyScalar(nA).add(t.object.position):(Bs.origin.copy(t.object.position),Bs.direction.set(0,0,-1).transformDirection(t.object.matrix),Math.abs(t.object.up.dot(Bs.direction))<h2?A.lookAt(t.target):(Xu.setFromNormalAndCoplanarPoint(t.object.up,t.target),Bs.intersectPlane(Xu,t.target))))}else t.object.isOrthographicCamera&&(t.object.zoom=Math.max(t.minZoom,Math.min(t.maxZoom,t.object.zoom/l)),t.object.updateProjectionMatrix(),z=!0);return l=1,y=!1,z||UA.distanceToSquared(t.object.position)>s||8*(1-BA.dot(t.object.quaternion))>s||xA.distanceToSquared(t.target)>0?(t.dispatchEvent(zu),UA.copy(t.object.position),BA.copy(t.object.quaternion),xA.copy(t.target),z=!1,!0):!1}}(),this.dispose=function(){t.domElement.removeEventListener("contextmenu",$),t.domElement.removeEventListener("pointerdown",RA),t.domElement.removeEventListener("pointercancel",WA),t.domElement.removeEventListener("wheel",S),t.domElement.removeEventListener("pointermove",LA),t.domElement.removeEventListener("pointerup",WA),t._domElementKeyEvents!==null&&(t._domElementKeyEvents.removeEventListener("keydown",w),t._domElementKeyEvents=null)};const t=this,i={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let r=i.NONE;const s=1e-6,a=new Gc,o=new Gc;let l=1;const c=new L,u=new NA,h=new NA,p=new NA,g=new NA,m=new NA,d=new NA,f=new NA,E=new NA,v=new NA,C=new L,x=new NA;let y=!1;const U=[],R={};function B(M){return M!==null?2*Math.PI/60*t.autoRotateSpeed*M:2*Math.PI/60/60*t.autoRotateSpeed}function F(){return Math.pow(.95,t.zoomSpeed)}function k(M){o.theta-=M}function Y(M){o.phi-=M}const X=function(){const M=new L;return function(q,UA){M.setFromMatrixColumn(UA,0),M.multiplyScalar(-q),c.add(M)}}(),T=function(){const M=new L;return function(q,UA){t.screenSpacePanning===!0?M.setFromMatrixColumn(UA,1):(M.setFromMatrixColumn(UA,0),M.crossVectors(t.object.up,M)),M.multiplyScalar(q),c.add(M)}}(),O=function(){const M=new L;return function(q,UA){const BA=t.domElement;if(t.object.isPerspectiveCamera){const xA=t.object.position;M.copy(xA).sub(t.target);let gA=M.length();gA*=Math.tan(t.object.fov/2*Math.PI/180),X(2*q*gA/BA.clientHeight,t.object.matrix),T(2*UA*gA/BA.clientHeight,t.object.matrix)}else t.object.isOrthographicCamera?(X(q*(t.object.right-t.object.left)/t.object.zoom/BA.clientWidth,t.object.matrix),T(UA*(t.object.top-t.object.bottom)/t.object.zoom/BA.clientHeight,t.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),t.enablePan=!1)}}();function W(M){t.object.isPerspectiveCamera||t.object.isOrthographicCamera?l/=M:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),t.enableZoom=!1)}function K(M){t.object.isPerspectiveCamera||t.object.isOrthographicCamera?l*=M:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),t.enableZoom=!1)}function j(M){if(!t.zoomToCursor)return;y=!0;const iA=t.domElement.getBoundingClientRect(),q=M.clientX-iA.left,UA=M.clientY-iA.top,BA=iA.width,xA=iA.height;x.x=q/BA*2-1,x.y=-(UA/xA)*2+1,C.set(x.x,x.y,1).unproject(t.object).sub(t.object.position).normalize()}function Z(M){return Math.max(t.minDistance,Math.min(t.maxDistance,M))}function J(M){u.set(M.clientX,M.clientY)}function Q(M){j(M),f.set(M.clientX,M.clientY)}function N(M){g.set(M.clientX,M.clientY)}function sA(M){h.set(M.clientX,M.clientY),p.subVectors(h,u).multiplyScalar(t.rotateSpeed);const iA=t.domElement;k(2*Math.PI*p.x/iA.clientHeight),Y(2*Math.PI*p.y/iA.clientHeight),u.copy(h),t.update()}function lA(M){E.set(M.clientX,M.clientY),v.subVectors(E,f),v.y>0?W(F()):v.y<0&&K(F()),f.copy(E),t.update()}function cA(M){m.set(M.clientX,M.clientY),d.subVectors(m,g).multiplyScalar(t.panSpeed),O(d.x,d.y),g.copy(m),t.update()}function _A(M){j(M),M.deltaY<0?K(F()):M.deltaY>0&&W(F()),t.update()}function TA(M){let iA=!1;switch(M.code){case t.keys.UP:M.ctrlKey||M.metaKey||M.shiftKey?Y(2*Math.PI*t.rotateSpeed/t.domElement.clientHeight):O(0,t.keyPanSpeed),iA=!0;break;case t.keys.BOTTOM:M.ctrlKey||M.metaKey||M.shiftKey?Y(-2*Math.PI*t.rotateSpeed/t.domElement.clientHeight):O(0,-t.keyPanSpeed),iA=!0;break;case t.keys.LEFT:M.ctrlKey||M.metaKey||M.shiftKey?k(2*Math.PI*t.rotateSpeed/t.domElement.clientHeight):O(t.keyPanSpeed,0),iA=!0;break;case t.keys.RIGHT:M.ctrlKey||M.metaKey||M.shiftKey?k(-2*Math.PI*t.rotateSpeed/t.domElement.clientHeight):O(-t.keyPanSpeed,0),iA=!0;break}iA&&(M.preventDefault(),t.update())}function SA(){if(U.length===1)u.set(U[0].pageX,U[0].pageY);else{const M=.5*(U[0].pageX+U[1].pageX),iA=.5*(U[0].pageY+U[1].pageY);u.set(M,iA)}}function QA(){if(U.length===1)g.set(U[0].pageX,U[0].pageY);else{const M=.5*(U[0].pageX+U[1].pageX),iA=.5*(U[0].pageY+U[1].pageY);g.set(M,iA)}}function te(){const M=U[0].pageX-U[1].pageX,iA=U[0].pageY-U[1].pageY,q=Math.sqrt(M*M+iA*iA);f.set(0,q)}function DA(){t.enableZoom&&te(),t.enablePan&&QA()}function H(){t.enableZoom&&te(),t.enableRotate&&SA()}function Me(M){if(U.length==1)h.set(M.pageX,M.pageY);else{const q=hA(M),UA=.5*(M.pageX+q.x),BA=.5*(M.pageY+q.y);h.set(UA,BA)}p.subVectors(h,u).multiplyScalar(t.rotateSpeed);const iA=t.domElement;k(2*Math.PI*p.x/iA.clientHeight),Y(2*Math.PI*p.y/iA.clientHeight),u.copy(h)}function EA(M){if(U.length===1)m.set(M.pageX,M.pageY);else{const iA=hA(M),q=.5*(M.pageX+iA.x),UA=.5*(M.pageY+iA.y);m.set(q,UA)}d.subVectors(m,g).multiplyScalar(t.panSpeed),O(d.x,d.y),g.copy(m)}function FA(M){const iA=hA(M),q=M.pageX-iA.x,UA=M.pageY-iA.y,BA=Math.sqrt(q*q+UA*UA);E.set(0,BA),v.set(0,Math.pow(E.y/f.y,t.zoomSpeed)),W(v.y),f.copy(E)}function MA(M){t.enableZoom&&FA(M),t.enablePan&&EA(M)}function ie(M){t.enableZoom&&FA(M),t.enableRotate&&Me(M)}function RA(M){t.enabled!==!1&&(U.length===0&&(t.domElement.setPointerCapture(M.pointerId),t.domElement.addEventListener("pointermove",LA),t.domElement.addEventListener("pointerup",WA)),tA(M),M.pointerType==="touch"?D(M):ue(M))}function LA(M){t.enabled!==!1&&(M.pointerType==="touch"?eA(M):we(M))}function WA(M){mA(M),U.length===0&&(t.domElement.releasePointerCapture(M.pointerId),t.domElement.removeEventListener("pointermove",LA),t.domElement.removeEventListener("pointerup",WA)),t.dispatchEvent(Wu),r=i.NONE}function ue(M){let iA;switch(M.button){case 0:iA=t.mouseButtons.LEFT;break;case 1:iA=t.mouseButtons.MIDDLE;break;case 2:iA=t.mouseButtons.RIGHT;break;default:iA=-1}switch(iA){case Rn.DOLLY:if(t.enableZoom===!1)return;Q(M),r=i.DOLLY;break;case Rn.ROTATE:if(M.ctrlKey||M.metaKey||M.shiftKey){if(t.enablePan===!1)return;N(M),r=i.PAN}else{if(t.enableRotate===!1)return;J(M),r=i.ROTATE}break;case Rn.PAN:if(M.ctrlKey||M.metaKey||M.shiftKey){if(t.enableRotate===!1)return;J(M),r=i.ROTATE}else{if(t.enablePan===!1)return;N(M),r=i.PAN}break;default:r=i.NONE}r!==i.NONE&&t.dispatchEvent(po)}function we(M){switch(r){case i.ROTATE:if(t.enableRotate===!1)return;sA(M);break;case i.DOLLY:if(t.enableZoom===!1)return;lA(M);break;case i.PAN:if(t.enablePan===!1)return;cA(M);break}}function S(M){t.enabled===!1||t.enableZoom===!1||r!==i.NONE||(M.preventDefault(),t.dispatchEvent(po),_A(M),t.dispatchEvent(Wu))}function w(M){t.enabled===!1||t.enablePan===!1||TA(M)}function D(M){switch(rA(M),U.length){case 1:switch(t.touches.ONE){case Hn.ROTATE:if(t.enableRotate===!1)return;SA(),r=i.TOUCH_ROTATE;break;case Hn.PAN:if(t.enablePan===!1)return;QA(),r=i.TOUCH_PAN;break;default:r=i.NONE}break;case 2:switch(t.touches.TWO){case Hn.DOLLY_PAN:if(t.enableZoom===!1&&t.enablePan===!1)return;DA(),r=i.TOUCH_DOLLY_PAN;break;case Hn.DOLLY_ROTATE:if(t.enableZoom===!1&&t.enableRotate===!1)return;H(),r=i.TOUCH_DOLLY_ROTATE;break;default:r=i.NONE}break;default:r=i.NONE}r!==i.NONE&&t.dispatchEvent(po)}function eA(M){switch(rA(M),r){case i.TOUCH_ROTATE:if(t.enableRotate===!1)return;Me(M),t.update();break;case i.TOUCH_PAN:if(t.enablePan===!1)return;EA(M),t.update();break;case i.TOUCH_DOLLY_PAN:if(t.enableZoom===!1&&t.enablePan===!1)return;MA(M),t.update();break;case i.TOUCH_DOLLY_ROTATE:if(t.enableZoom===!1&&t.enableRotate===!1)return;ie(M),t.update();break;default:r=i.NONE}}function $(M){t.enabled!==!1&&M.preventDefault()}function tA(M){U.push(M)}function mA(M){delete R[M.pointerId];for(let iA=0;iA<U.length;iA++)if(U[iA].pointerId==M.pointerId){U.splice(iA,1);return}}function rA(M){let iA=R[M.pointerId];iA===void 0&&(iA=new NA,R[M.pointerId]=iA),iA.set(M.pageX,M.pageY)}function hA(M){const iA=M.pointerId===U[0].pointerId?U[1]:U[0];return R[iA.pointerId]}t.domElement.addEventListener("contextmenu",$),t.domElement.addEventListener("pointerdown",RA),t.domElement.addEventListener("pointercancel",WA),t.domElement.addEventListener("wheel",S,{passive:!1}),this.update()}}class d2{constructor(A,e=0,t=!0){if(A){const{title:i,header:r,rows:s}=this.extract(A);this._title=i,this._header=r,this._rows=s}}extract(A){const e=A.toString().split(/\r?\n/),t=e[0],i=e[1].split(","),r=e[e.length-1]===""?e.length-1:e.length;return{title:t,header:i,rows:e.slice(1,r)}}get columnCount(){return this.header?this.header.length:this.rows[0].length}get rowCount(){return this.rows.length}getNumber(A,e){const t=this.rows[A];return parseFloat(t.split(",")[e])}get title(){return this._title}get header(){return this._header}get rows(){return this._rows}}class fl extends ln{constructor(A,e=30,t=1,i=8,r=!1){super(),this.type="HelixGeometry",this.parameters={path:A,tubularSegments:e,radius:t,radialSegments:i,closed:r};const s=A.computeFrenetFrames(e,r);this.tangents=s.tangents,this.normals=s.normals,this.binormals=s.binormals;const a=new L,o=new L,l=new NA;let c=new L;const u=[],h=[],p=[],g=[],m=[];d(),this.setIndex(g),this.setAttribute("position",new ht(u,3)),this.setAttribute("normal",new ht(h,3)),this.setAttribute("uv",new ht(p,2)),this.setAttribute("vColors",new ht(m,3));function d(){for(let C=0;C<e;C++)f(C);f(r===!1?e:0),v(),E()}function f(C){const x=A.getUtoTmapping(C/e);c=A.getPoint(x,c);const y=A.getColor(x),U=s.normals[C],R=s.binormals[C];for(let B=0;B<=i;B++){const F=B/i*Math.PI*2,k=Math.sin(F),Y=-Math.cos(F);o.x=Y*U.x+k*R.x,o.y=Y*U.y+k*R.y,o.z=Y*U.z+k*R.z,o.normalize(),h.push(o.x,o.y,o.z),a.x=c.x+t*o.x,a.y=c.y+t*o.y,a.z=c.z+t*o.z,u.push(a.x,a.y,a.z),m.push(y.r,y.g,y.b)}}function E(){for(let C=1;C<=e;C++)for(let x=1;x<=i;x++){const y=(i+1)*(C-1)+(x-1),U=(i+1)*C+(x-1),R=(i+1)*C+x,B=(i+1)*(C-1)+x;g.push(y,U,B),g.push(U,R,B)}}function v(){for(let C=0;C<=e;C++)for(let x=0;x<=i;x++)l.x=C/e,l.y=x/i,p.push(l.x,l.y)}}copy(A){return super.copy(A),this.parameters=Object.assign({},A.parameters),this}toJSON(){const A=super.toJSON();return A.path=this.parameters.path.toJSON(),A}static fromJSON(A){return new fl(new Curves[A.path.type]().fromJSON(A.path),A.tubularSegments,A.radius,A.radialSegments,A.closed)}}const Jo=12,bf=[],Tf=[];var mr,Br,wr,wi,vr,Tt;class p2{constructor(A,e=-1,t=1.5,i=.4,r=1,s=2.5){se(this,mr,void 0);se(this,Br,void 0);se(this,wr,void 0);se(this,wi,void 0);se(this,vr,void 0);se(this,Tt,void 0);this.settings=A,this.csv=new d2(A.showcaseCSV),this.helixConfiguration={minT:e,maxT:t,minR:i,maxR:r,height:s},jA(this,wr,A.cold),jA(this,wi,A.zero),jA(this,vr,A.warm),this.curve=[]}createMesh(A={wireframe:!1,vertexColors:!0}){this.createCurve();const e=this.createGeometry();A.wireframe&&(A.color=dr.styledColor("--wireframe-color"));const[t,i,r]=wA(this,mr).toArray();e.translate(-t,-i,-r);const s=new el(A);return jA(this,Br,new It(e,s)),wA(this,Br)}createCurve(){if(this.curve.length===0){this.years=this.csv.rowCount;for(let A=0;A<this.years;A++)for(let e=0;e<12;e++){const t=this.helixPoint(A,e);t&&this.curve.push(t)}jA(this,mr,this.centerOfGravity())}}centerOfGravity(){if(!this.curve||this.curve.length===0)return new L(0,0,0);let A=0,e=0,t=0;const i=this.curve.length;return this.curve.forEach((r,s)=>{A+=r.radius*r.cosX,e+=r.radius*r.sinX,t+=s/i*this.height}),new L(A/i,e/i,t/i)}createGeometry(){const A=this.settings.radiusFactor*this.helixConfiguration.height/this.years,e=new fl(new g2(this),this.settings.tubularSegments*(this.curve.length-1),A,this.settings.radialSegments,!1),t=e.getAttribute("vColors"),i=new ft(new Float32Array(t.array),3);return e.setAttribute("color",i),e}helixPoint(A,e){const t=this.csv.getNumber(A,e+1);if(t){const i=Qf(this.helixConfiguration.minT,this.helixConfiguration.maxT,this.helixConfiguration.minR,this.helixConfiguration.maxR,t),r=new YA;return t<0?r.lerpColors(wA(this,wi),wA(this,wr),Math.abs(t)):r.lerpColors(wA(this,wi),wA(this,vr),t),{sinX:bf[e],cosX:Tf[e],radius:i,temperature:t,color:r}}}get height(){return this.helixConfiguration.height}get length(){return this.curve.length/Jo}curveIndex(A){return Math.floor((this.curve.length-1)*A)}info(A){return this.curve[this.curveIndex(A)]}createTitleDiv(A){const e="heading-div",t=A.querySelector(`.${e}`);return t&&A.removeChild(t),wA(this,Tt)||(jA(this,Tt,document.createElement("DIV")),wA(this,Tt).setAttribute("class",e),A.appendChild(wA(this,Tt))),wA(this,Tt).innerText=this.csv.title,wA(this,Tt)}}mr=new WeakMap,Br=new WeakMap,wr=new WeakMap,wi=new WeakMap,vr=new WeakMap,Tt=new WeakMap;class g2 extends c1{constructor(A){super(),this.helix=A}getPoint(A,e=new L){const t=2*Math.PI*this.helix.length*A,i=this.helix.curveIndex(A),r=this.helix.curve[i],s=this.helix.curve[i+1]||r,a=i/(this.helix.curve.length-1),o=(i+1)/(this.helix.curve.length-1),l=Qf(a,o,r.radius,s.radius,A),c=l*Math.cos(t),u=l*Math.sin(t),h=this.helix.height*A;return e.set(c,u,h)}getColor(A){const e=this.helix.curveIndex(A),t=this.helix.curve[e],i=this.helix.curve[e+1]||t,r=e/(this.helix.curve.length-1),s=(e+1)/(this.helix.curve.length-1);return new YA().lerpColors(t.color,i.color,(A-r)/(s-r))}}for(let n=0;n<Jo;n++){const A=2*Math.PI*n/Jo;bf.push(Math.sin(A)),Tf.push(Math.cos(A))}function Qf(n,A,e,t,i){return A-n===0?(e+t)/2:(i-n)*(t-e)/(A-n)+e}HTMLCanvasElement.prototype.getContext=function(n){return function(A,e){return e=e||{},e.preserveDrawingBuffer=!0,n.call(this,A,e)}}(HTMLCanvasElement.prototype.getContext);var vi,_i,Un,ks,Lf;class m2{constructor(A,e={All:void 0,Helix:void 0}){se(this,ks);se(this,vi,void 0);se(this,_i,void 0);se(this,Un,void 0);jA(this,vi,()=>document.body),vl(this,ks,Lf).call(this,A,e),document.addEventListener("keydown",t=>{t.altKey&&t.key==="s"&&(t.stopPropagation(),t.preventDefault(),this.capture())})}capture(A=wA(this,vi)){console.log(`screenCapture ${A}`);const e=A();if(!e)throw new Error("No element to capture");setTimeout(()=>{const i=window.getComputedStyle(document.body).getPropertyValue("background-color");Sf(e,{backgroundColor:i}).then(r=>{const s=document.createElement("a");s.href=r.toDataURL(),s.download="climate-helix.png",s.click()})},100)}}vi=new WeakMap,_i=new WeakMap,Un=new WeakMap,ks=new WeakSet,Lf=function(A,e){const t={};jA(this,_i,e);for(const[s,a]of Object.entries(e))t[s]=void 0;const i=A.folder,r=A.property;r.selection="All",jA(this,Un,"All"),jA(this,vi,()=>(console.log(wA(this,Un)),console.log(wA(this,_i)),wA(this,_i)[wA(this,Un)])),r.on_capture_clicked=()=>this.capture(),dr.addRadioButtons(i,r.selection,t,(s,a,o)=>{console.log(`${s}, ${a}, ${o}`),jA(this,Un,o)}),i.add(r,"on_capture_clicked").name("Click or press 'alt s'")};const B2=`<?xml version="1.0" ?>
...
</svg>`,w2=`<p>The 3D helix visualizes <u>differences to a temperature mean</u> calculated for a specific month within the region of
...
</ol>`,sa=document.createElement("DIV"),If=".container-div";sa.setAttribute("class","container-div");document.body.appendChild(sa);const rr=new dr,v2=new u2({container:sa});let ui,Cn,sr,Xt,ws,vs,Ji;function _2(){sr=new l1,Xt=new Ch({antialias:!0}),Xt.setPixelRatio(window.devicePixelRatio);const n=window.innerWidth,A=window.innerHeight;Xt.setSize(n,A),sa.appendChild(Xt.domElement),C2();const e=n/A;Cn=new At(50,e),Cn.position.set(0,0,5.5),sr.add(Cn),ui=new Oi,sr.add(ui),new f2(Cn,Xt.domElement).update(),window.addEventListener("resize",y2),window.addEventListener(XA.CREATE_HELIX,Rf),document.body.addEventListener(XA.THEME_CHANGED.toString(),U2);const i={All:document.body,Helix:Xt.domElement};new m2(rr.captureSettings(),i),Ji=E2(),x2(),XA.dispatchEvent(XA.THEME_CHANGED),Hf()}function C2(){return new hl(document.body,n=>{const e=window.getComputedStyle(document.body).getPropertyValue("background-color");sr.background=new YA(e)})}function Rf(){ws&&ui.remove(ws),vs&&ui.remove(vs);const n=new p2(rr);rr.showFaces&&(ws=n.createMesh(),ui.add(ws)),rr.showWireframe&&(vs=n.createMesh({wireframe:!0,vertexColors:!1}),ui.add(vs));const A=document.querySelector(If);n.createTitleDiv(A)}function E2(){const n=document.createElement("DIV");n.innerHTML=B2,Ji=n.querySelector("#info-icon"),Ji.classList.add("show"),Ji.addEventListener("click",()=>{const e=document.querySelector("#info-div");e==null||e.classList.toggle("show");const t=document.querySelector("canvas");t==null||t.classList.toggle("transparent")});const A=document.querySelector(If);A==null||A.appendChild(Ji)}function x2(){const n=document.createElement("DIV");n.setAttribute("id","info-div"),n.innerHTML=w2;const A=document.querySelector("#info-icon");A==null||A.insertAdjacentElement("beforebegin",n);const e=document.createElement("SPAN");e.setAttribute("id","version-info"),e.innerHTML="v0.2.5",A==null||A.insertAdjacentElement("beforebegin",e)}function Hf(){requestAnimationFrame(Hf),Xt.render(sr,Cn)}function U2(){rr.initializeColors(),Rf()}function y2(){Cn.aspect=window.innerWidth/window.innerHeight,Cn.updateProjectionMatrix(),Xt.setSize(window.innerWidth,window.innerHeight)}_2();v2.initTheme();
