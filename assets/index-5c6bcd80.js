...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zt,depthTest:!1,depthWrite:!1})}function Ql(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:zt,depthTest:!1,depthWrite:!1})}function Il(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wo(),fragmentShader:`
